...
public class BuildServImpl {
    private static final Logger logger = LoggerFactory.getLogger(BuildServImpl.class);
    ...
    public static void execute(TableInfo tableInfo) {
        ...
        try {
            ...
            String mapperBeanName = StringUtils.lowererCaseFirsrLetter(mapperName);
            ...
            bw.write("@Service(\"" + StringUtils.lowererCaseFirsrLetter(tableInfo.getBeanName()) + "Service\")");
            bw.newLine();
            bw.write("public class " + className + " implements " + interfaceName + " {");
            bw.newLine();
            bw.write("    @Resource");
            bw.newLine();
            bw.write("    private " + mapperName + "<" + tableInfo.getBeanName() + ", " + tableInfo.getBeanParamName() + "> " + StringUtils.lowererCaseFirsrLetter(mapperName) + ";");
            bw.newLine();
            bw.newLine();
            ...
            // 分页查询方法
            BuildComment.createFieldComment(bw, "分页查询方法");
            bw.write("    @Override");
            bw.newLine();
            ...
            bw.write("\t\tif (listBean == null || listBean.isEmpty()) {\n" +
                    "\t\t\treturn 0;\n" +
                    "\t\t}\n" +
                    "\t\treturn this." + mapperBeanName + ".insertBatch(listBean);");
            bw.newLine();
            bw.write("    }");
            bw.newLine();
            bw.newLine();
            ...
            for (Map.Entry<String, List<FieldInfo>> entry : keyIndexMap.entrySet()) {
                ...
                bw.newLine();
                bw.write("\t\treturn this." + mapperBeanName + ".selectBy" + methodName + "(" + methodBodyParams + ");");
                bw.newLine();
                bw.write("    }");
                bw.newLine();
                bw.newLine();
                ...
                bw.newLine();
                bw.write("\t\treturn this." + mapperBeanName + ".updateBy" + methodName + "(bean, " + methodBodyParams + ");");
                bw.newLine();
                bw.write("    }");
                bw.newLine();
                bw.newLine();
                ...
                bw.newLine();
                bw.write("\t\treturn this." + mapperBeanName + ".deleteBy" + methodName + "(" + methodBodyParams + ");");
                bw.newLine();
                bw.write("    }");
                bw.newLine();
                bw.newLine();
